...
const Info = () => (
  <InfoLayout
    title="О сервисе"
    lead="traffic markering — площадка рекламных интеграций: заказчик публикует объявление со ставкой за 1000 просмотров, криатор берёт его в работу и снимает ролик, а выплата считается по реальным просмотрам этого ролика."
    showUpdated={false}
  >
    <section className={styles.section}>
      <h2 className={styles.heading}>Как это работает</h2>
      <ol className={styles.list}>
        <li>Заказчик создаёт объявление: описание интеграции, ставка за 1000 просмотров и бюджет.</li>
        <li>Криатор откликается и публикует ролик на своей площадке.</li>
        <li>
          Сервис периодически запрашивает у площадки статистику этого ролика по официальному API
          и начисляет криатору выплату по набранным просмотрам, пока не исчерпан бюджет объявления.
        </li>
      </ol>
    </section>
    ...
    <section className={styles.section}>
      ...
      <p className={styles.text}>
        Просмотры мы берём не со слов криатора и не скриншотами, а из официального API площадки.
        Для этого криатор один раз подключает свой аккаунт через стандартную страницу согласия
    ...
    <section className={styles.section}>
      ...
      <p className={styles.text}>
        Отвязать аккаунт можно в любой момент в профиле криатора: кнопка «отвязать» рядом с аккаунтом.
        Сохранённые токены доступа при этом удаляются безвозвратно. Отозвать доступ можно и на стороне
        площадки — в настройках подключённых приложений вашего аккаунта.
      </p>
    </section>
