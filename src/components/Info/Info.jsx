...
const Info = () => (
  <InfoLayout
    title="О сервисе"
    lead="offer — площадка рекламных интеграций: заказчик публикует объявление со ставкой за 1000 просмотров, криатор берёт его в работу и снимает ролик, а выплата считается по реальным просмотрам этого ролика."
    showUpdated={false}
  >
